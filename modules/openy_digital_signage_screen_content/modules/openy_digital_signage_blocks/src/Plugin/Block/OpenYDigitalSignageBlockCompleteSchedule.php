...
/**
 * Provides Complete schedule block.
 *
 * @Block(
 *   id = "openy_digital_signage_complete_schedule",
 *   admin_label = @Translation("Today's schedule"),
 *   category = @Translation("Digital Signage")
 * )
 */
class OpenYDigitalSignageBlockCompleteSchedule extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * OpenYDigitalSignageBlockCompleteSchedule constructor.
   *
