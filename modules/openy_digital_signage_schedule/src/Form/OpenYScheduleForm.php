...
class OpenYScheduleForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Digital Signage Schedule %label has been created.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Digital Signage Schedule %label has been saved.', [
          '%label' => $entity->label(),
        ]));
    }
